...
class NPCFriendPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        self.title = DirectLabel(parent=self, relief=None, text=TTLocalizer.NPCFriendPageTitle, text_scale=0.12, textMayChange=0, pos=(0, 0, 0.6), text_font=ToontownGlobals.getSchtickerFont())
