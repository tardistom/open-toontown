...
class EventsPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.loadNewsTab()
        self.titleLabel = DirectLabel(parent=self, relief=None, text=TTLocalizer.EventsPageHostTabTitle, text_scale=TTLocalizer.EPtitleLabel, textMayChange=True, pos=self.hostingGui.find('**/myNextParty_text_locator').getPos(), text_font=ToontownGlobals.getSchtickerFont())
        return
