...
from . import SuitDNA, DistributedSuitBase
...
class SuitAvatarPanel(AvatarPanel.AvatarPanel):
    ...
    def __init__(self, avatar):
        ...
        maxSuitHP = int(avatar.getMaxHP())
        curSuitHP = int(avatar.getHP())
        ...
        if not wantDev:
            ...
            self.hpLabel = DirectLabel(parent=self.frame, pos=(0.0125, 0, -0.15), relief=None, text=TTLocalizer.AvatarPanelCogHP % (curSuitHP, maxSuitHP), text_font=avatar.getFont(), text_fg=Vec4(0, 0, 0, 1), text_pos=(0, 0), text_scale = 0.047, text_wordwrap = 7.5, text_shadow=(1, 1, 1, 1))
